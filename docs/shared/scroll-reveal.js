// scroll-reveal.js — fades/slides ".reveal" elements into view as they
// enter the viewport (with a Safari fallback for elements already visible
// on load, since IntersectionObserver can miss those).
