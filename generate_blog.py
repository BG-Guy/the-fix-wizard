...
def navbar_html(depth=2):
    ...
    return f'''    <nav id="navbar" class="navbar">
        <div class="container nav-container">
            <a href="{root}" class="logo"><img src="{root}assets/images/the-fix-wizard-logo-3.png" alt="The Fix Wizard" class="logo-img" width="199" height="110"></a>
            <ul class="nav-links">
    ...
    return f'''    <footer class="footer">
        <div class="container footer-grid">
            <div class="footer-brand">
                <a href="{root}" class="logo"><img src="{root}assets/images/the-fix-wizard-logo-3.png" alt="The Fix Wizard" class="logo-img footer-logo-img" width="199" height="110"></a>
